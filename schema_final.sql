...
CREATE TABLE users (
    ...
    role TEXT NOT NULL, -- 'owner', 'admin', 'super_admin', 'staff'
    store_name TEXT,
    subscription_status TEXT DEFAULT 'trial',
    subscription_expiry DATETIME,
    parentId TEXT, -- For staff: link to owner's id
    maxStaffLimit INTEGER DEFAULT 1, -- Cached limit from package
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP
);

-- Default users (Passwords are plaintext for now as per simple requirement, or simple hash)
INSERT OR IGNORE INTO users (id, username, password, role, subscription_status, subscription_expiry, maxStaffLimit) VALUES ('u1', 'owner', 'owner123', 'owner', 'trial', datetime('now', '+7 days'), 1);
INSERT OR IGNORE INTO users (id, username, password, role, subscription_status, subscription_expiry, maxStaffLimit) VALUES ('u2', 'admin', 'admin123', 'admin', 'active', datetime('now', '+100 years'), 99);
INSERT OR IGNORE INTO users (id, username, password, role, subscription_status, subscription_expiry, maxStaffLimit) VALUES ('u3', 'super_admin', 'super123', 'super_admin', 'active', datetime('now', '+100 years'), 99);
...
INSERT OR IGNORE INTO subscription_packages (id, name, days, price, maxStaff) VALUES ('pkg_trial', '7 Days Trial', 7, 0, 1);
INSERT OR IGNORE INTO subscription_packages (id, name, days, price, maxStaff) VALUES ('pkg_std_30', 'Standard 30 Days', 30, 300, 3);
INSERT OR IGNORE INTO subscription_packages (id, name, days, price, maxStaff) VALUES ('pkg_pro_30', 'Pro 30 Days', 30, 500, 10);
