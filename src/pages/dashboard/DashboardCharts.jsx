...
export const PriceChart = ({ priceChartData }) => (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
...
const DashboardCharts = ({ chartData, priceChartData, showActivity = true, showPrice = true }) => {
    if (!showActivity && !showPrice) return null;

    if (showActivity && showPrice) {
        return (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <ActivityChart chartData={chartData} />
                <PriceChart priceChartData={priceChartData} />
            </div>
        );
    }
    ...
    return (
        <div>
            {showActivity && <ActivityChart chartData={chartData} />}
            {showPrice && <PriceChart priceChartData={priceChartData} />}
        </div>
    );
};
