import { RefreshCw, Search, User, Printer, Eye, ChevronLeft, ChevronRight } from 'lucide-react';
                        ...
                        {pagination && pagination.totalPages > 1 && (
                            <div className="px-6 py-4 bg-gray-50/50 border-t border-gray-100 flex items-center justify-between">
                                <div className="text-xs font-black text-gray-400 uppercase tracking-widest">
                                    แสดง {filteredRecords.length} จากทั้งหมด {pagination.totalCount} รายการ
                                </div>
                                <div className="flex items-center space-x-2">
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-xl px-4 py-2 flex items-center space-x-2">
